 ...
 * @author beetsoft
 */
public class NhanhKhachFrame extends javax.swing.JFrame {
    ...
    static int maHD = 0; 
    static int maL = 0;
    LichSpaDB lichSpaDB = new LichSpaDB();
    public NhanhKhachFrame() {
        initComponents();
        clearData();
    }
    ...
    private void initComponents() {
        ...
        btHoanTatNhanKhach.setText("Hoan tat nhan khach");
    ...
    private void btHoanTatNhanKhachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btHoanTatNhanKhachActionPerformed
        try {
            ...
            if (tbShowNVPV.getRowCount() != 0) {
                JOptionPane.showMessageDialog(NhanhKhachFrame.this, "Ban phai chon nhan vien phuc vu truoc khi hoan tat!" , "Canh bao" , JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            JOptionPane.showMessageDialog(NhanhKhachFrame.this, "Nhan khach thanh cong!" , "Thanh cong" , JOptionPane.INFORMATION_MESSAGE);
    
                
            } 
        } catch (SQLException ex) {
            Logger.getLogger(NhanhKhachFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnSearchKhachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchKhachActionPerformed
        ...
        List<Lich> ll =  ldb.get_by_lstsdt_and_date(lkh, "2019-12-19 08:00:00");
    ...
    public void showData(List<Lich> list){
       ...
       for (int i = 0; i< list.size(); i++) {
           ...
           LichSpa ls = lichSpaDB.get_by_id(list.get(i).getMaLSpa());
           mh.addElement(ls.getThoigian());
    ...
    private void btnTaoLichActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoLichActionPerformed
        // TODO add your handling code here:
        HienThiLichTrongFrame hienThiLichTrongFrame = new HienThiLichTrongFrame();
        hienThiLichTrongFrame.setVisible(true);
...
//        dichvuNLEnable(false);
    ...
    private void tbShowDVNLMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbShowDVNLMouseClicked
        ...
        if (row !=-1){
            ...
            String soluong = JOptionPane.showInputDialog(NhanhKhachFrame.this, title);
            if (soluong != null) {
                ...
                if (isNumeric(soluong) != -1) {
                    if (cbDVNL.getSelectedIndex() == 1) {
                        ...
                        if (isNumeric(soluong) > value) {
                            JOptionPane.showMessageDialog(NhanhKhachFrame.this, "So luong ban nhap vuot qua " + value+ " so luong trong kho!" , "That bai" , JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    } else {
                        // dich vu check nhan vien dang ranh 
                        int maDv =  (int) tbShowDVNL.getValueAt(row, 0);
                        NhanVienDichVuDB nvdvdb = new NhanVienDichVuDB();
                        List<NhanVien> l_nv = nvdvdb.get_by_dichvu(maDv);
                        int count = 0;
                        for (NhanVien nv : l_nv) {
                            if (nv.getStatus() == 1) {
                                count += 1;
                            }
                        }
                        if (l_nv.size() == count) {
                             JOptionPane.showMessageDialog(NhanhKhachFrame.this, "Khong co nhan vien phuc vu dich vu "+ tbShowDVNL.getValueAt(row, 1) +" vao thoi diem nay" , "Khong thanh cong" , JOptionPane.ERROR_MESSAGE);
                            return;
                        }
                    ...
                    JOptionPane.showMessageDialog(NhanhKhachFrame.this, "Ki tu ban nhap phai la so! Vui long thuc hien lai", "That bai" , JOptionPane.WARNING_MESSAGE);
                }         
...
//            dichvuNLEnable(!is_show);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanhKhachFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhanhKhachFrame().setVisible(true);
            }
        });
    }
